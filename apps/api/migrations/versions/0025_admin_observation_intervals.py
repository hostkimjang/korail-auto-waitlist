"""Persist administrator defaults for backend seat observation intervals."""

import sqlalchemy as sa
from alembic import op

revision = "0025_admin_observation_intervals"
down_revision = "0024_watch_observation_speed"
branch_labels = None
depends_on = None
