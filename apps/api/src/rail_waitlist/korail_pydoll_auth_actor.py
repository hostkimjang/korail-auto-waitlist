...
from .korail_pydoll_auth_contracts import (
    KorailCredentialInput as ContractKorailCredentialInput,
)
from .korail_pydoll_auth_contracts import KorailLoginMethod as ContractKorailLoginMethod
...
class PydollAuthenticationSessionActor[AuthSession: PydollAuthenticationSession]:
    ...
    async def discard_active_session(self) -> None:
        ...
        if active is not None:
            await self._cleanup(active.context.__aexit__(None, None, None))
