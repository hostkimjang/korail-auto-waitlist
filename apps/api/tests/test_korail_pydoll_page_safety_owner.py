...
def test_owner_has_exact_import_boundary_and_one_production_consumer() -> None:
    ...
    assert imports_from == {
        ...
        ("browser_service_availability", 2, "BrowserProviderUnavailable", None),
        ("browser_service_availability", 2, "ProviderUnavailableTrigger", None),
        (
            "browser_service_availability",
            2,
