...
ffmpeg -y -ss 00:00:11.74 -i docs/media/railwait-demo.mp4 -frames:v 1 -vf "scale=1280:-2:flags=lanczos" docs/media/railwait-demo-poster.png
...
공개 영상은 3초짜리 브랜드 장면에서 실제 UI로 이어지는 19.84초 구성입니다. 원본 녹화 앞의 브라우저 준비 화면 2.36초는 합성할 때 제외합니다.
